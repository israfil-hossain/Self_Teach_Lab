...
{ 
    $("#withdrawForm").validate({
        rules: {
            ...
            amount: {
                required: true,
                min: {{ App\Http\SiteHelpers::get_option('settingGeneral', 'minimum_withdraw') }},
        ...
        messages: {
            ...
            amount: {
                ...
                min: "The minimum withdraw amount should be {{ App\Http\SiteHelpers::get_option('settingGeneral', 'minimum_withdraw') }}",
