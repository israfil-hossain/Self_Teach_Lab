  ...
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-expand-md"
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center">
        <img class="navbar-brand-logo" src="{{ asset('asset/images/logo/icon2.png') }}" style="height:40px"title="Self_Teach_Lab">
        <span class="navbar-brand-text hidden-xs-down">Self_Teach_Lab</span>
      </div>
