            ...
            <div class="row mt-4">
                ...
                <div class="col-xl-9 col-lg-9 col-md-8">
                        ...
                        <div class="cv-course-container">
                            ...
                            <div class="course-image my-3">
                                {{-- <img src="@if(Storage::exists($blog->blog_image)){{ Storage::url("/storage/app/blogs".$blog->blog_image) }}@else{{ asset('backend/assets/images/blog_image.jpeg') }}@endif"> --}}
                                <img src="{{asset('public/storage/app/blogs/'.$blog->blog_image)}}">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 d-none d-md-block">
                    <section class="course-feature">
                        <h6 class="text-center mt-3">SUBSCRIBE TO Self_Teach BLOG</h6>
