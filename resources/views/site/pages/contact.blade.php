        ...
        <div class="container">
            <div class="row ct-block">
                <div class="ct-block-col col-xl-3 offset-xl-1 col-lg-4 offset-lg-0 col-md-4 offset-md-0 col-sm-12 offset-sm-3 col-12 offset-3 my-2">
                    ...
                    <div class="contact-detail">
                        ...
                        {{-- {{ App\Http\Sitehelpers::get_option('pageContact', 'telephone') }} --}}
                        {{ App\Http\Sitehelpers::get_option('pageContact', 'telephone') }}
                    </div>
                </div>
                <div class="ct-block-col col-xl-3 offset-xl-1 col-lg-4 offset-lg-0 col-md-4 offset-md-0 col-sm-12 offset-sm-3 col-12 offset-3 my-2">
                    ...
                    <div class="contact-detail">
                        ...
                        {{ App\Http\Sitehelpers::get_option('pageContact', 'email') }}
                    </div>
                </div>
                <div class="ct-block-col col-xl-3 offset-xl-1 col-lg-4 offset-lg-0 col-md-4 offset-md-0 col-sm-12 offset-sm-3 col-12 offset-3 my-2">
                    <div class="contact-icon">
                    ...
                    <div class="contact-detail">
                        ...
                        {{ App\Http\Sitehelpers::get_option('pageContact', 'address') }}
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 vertical-align d-none d-lg-block map-block">
                    {{ App\Http\Sitehelpers::get_option('pageContact', 'map') }}
                </div>
