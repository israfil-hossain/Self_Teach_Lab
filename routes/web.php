...
// Quiz Section  
// ------------------------------------------------
Route::get('/classicquiz',[clasicController::class,'Classicindex'])->name('classicquiz');
...
// =============================================================================
    ...
    // Function accessed by Quizmaster 
    Route::group(['middleware' => 'role:quizmaster'], function () {
                
        Route::get('create-quiz',[QuestionController::class, 'create'])->name('quizmaster.create-quiz');
        Route::get('manage-quiz',[QuestionController::class, 'manage'])->name('quizmaster.manage-quiz');
...
// ====================================================================================
    ...
    Route::group(['middleware' => 'role:admin'], function () {
        Route::get('admin/dashboard', 'Admin\AdmindashboardController')->name('admin.dashboard');
        ...
        Route::get('admin/withdraw-requests', 'Admin\AdmindashboardController@withdrawRequests')->name('admin.withdraw.requests');
        Route::get('admin/approve-withdraw-request/{request_id}', 'Admin\AdmindashboardController@approveWithdrawRequest')->name('admin.approve.withdraw.request');
